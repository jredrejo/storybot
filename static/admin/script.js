...
const emojiKeywords = {
    ...
    '🧜': ['mermaid', 'siren', 'sea', 'mythical'],
    '🧛': ['vampire', 'monster', 'spooky'],
    '🧟': ['zombie', 'monster', 'spooky'],
    '🦸': ['superhero', 'hero', 'cape', 'poderoso'],
    '🦹': ['supervillain', 'villain', 'villano'],
    '🥷': ['ninja', 'stealth', 'shuriken'],
    '🤖': ['robot', 'machine', 'android', 'bicho'],
    '👽': ['alien', 'extraterrestre', 'space'],
    '🎅': ['santa', 'claus', 'christmas', 'navidad'],
    '🤶': ['mother', 'santa', 'christmas', 'navidad'],
    '🕵️': ['detective', 'spy', 'investigar'],
    '💂': ['guard', 'sentinel', 'guardia'],
    '👷': ['construction', 'worker', 'obras'],
    '👮': ['police', 'officer', 'policia'],
    '👦': ['boy', 'child', 'nino'],
    '👧': ['girl', 'child', 'nina'],
    '👶': ['baby', 'infant', 'bebe'],
    '👵': ['old', 'woman', 'grandma', 'abuela'],
    '👴': ['old', 'man', 'grandpa', 'abuelo'],
    '🧑‍🚀': ['astronaut', 'space', 'cosmonauta'],
    '🧑‍🌾': ['farmer', 'agriculture', 'granjero'],
    '🧑‍🍳': ['cook', 'chef', 'cocinero'],
    '🧑‍⚕️': ['doctor', 'nurse', 'medico'],
    '🧑‍🏫': ['teacher', 'educator', 'profesor'],
    '🧑‍✈️': ['pilot', 'plane', 'piloto'],
    '🏡': ['house', 'home', 'casa', 'garden'],
    '🏘️': ['houses', 'neighborhood', 'barrio', 'village'],
    '🛖': ['hut', 'shack', 'choza', 'cabaña'],
    '🏚️': ['old', 'house', 'ruin', 'casa', 'vieja'],
    '⛺': ['tent', 'camping', 'tienda', 'campamento'],
    '🏕️': ['camping', 'camp', 'campamento'],
    '🗽': ['statue', 'liberty', 'monumento', 'landmark'],
    '⛩️': ['shrine', 'torii', 'templo', 'japan'],
    '🕌': ['mosque', 'islamic', 'mezquita', 'templo'],
    '⛪': ['church', 'cathedral', 'iglesia', 'templo'],
    '🏛️': ['museum', 'classical', 'building', 'museo', 'edificio'],
    '🏟️': ['stadium', 'arena', 'estadio', 'deporte'],
    '🎡': ['ferris', 'wheel', 'amusement', 'parque', 'de', 'atracciones'],
    '🎢': ['roller', 'coaster', 'amusement', 'parque', 'de', 'atracciones'],
    '🌋': ['volcano', 'erupcion', 'lava', 'mountain'],
    '🏔️': ['snow', 'mountain', 'montana', 'nevada'],
    '⛰️': ['mountain', 'montana', 'hill'],
    '🗻': ['mount', 'fuji', 'mountain', 'montana', 'japon'],
    '🏜️': ['desert', 'desierto', 'sand', 'duna'],
    '🏝️': ['island', 'desert', 'isla', 'playa'],
    '🏖️': ['beach', 'playa', 'sand', 'summer'],
    '🏞️': ['national', 'park', 'nature', 'parque', 'paisaje'],
    '🌅': ['sunrise', 'amanecer', 'horizon'],
    '🌄': ['sunrise', 'mountains', 'amanecer', 'montanas'],
    '🌇': ['sunset', 'atardecer', 'city'],
    '🌃': ['night', 'city', 'noche', 'ciudad'],
    '🌌': ['milky', 'way', 'galaxy', 'galaxia', 'estrellas', 'noche', 'cielo'],
    '🌠': ['shooting', 'star', 'estrella', 'fugaz', 'deseo'],
    '🌉': ['bridge', 'puente', 'river'],
    '🌲': ['evergreen', 'tree', 'pino', 'arbol'],
    '🌳': ['deciduous', 'tree', 'arbol', 'hoja'],
    '🌴': ['palm', 'tree', 'palmera', 'tropical'],
    '🌵': ['cactus', 'desert', 'desierto', 'tropical'],
    '🍄': ['mushroom', 'hongo', 'seta', 'forest'],
    '🕳️': ['hole', 'agujero', 'buche'],
    '🌍': ['earth', 'globe', 'mundo', 'planeta', 'world']
};
